	...
	// Create An ArrayList to Hold Stock Names
		...
		public HashMap<String, String> getStocks() {
			...
			try {
				...
				// URL
					String techURL = "https://cloud.iexapis.com/stable/stock/market/collection/sector?collectionName=Health%20Care&token=sk_77ef8dc8d96c43f7ae4624d7ea5b228e";	
			...
			sector.add("<h1> This is a list of HealthCare tickers</h1>\n");
